    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700">
          For any privacy concerns, contact us at <a href="mailto:support@invoicemyte.com" className="text-blue-600 underline">support@invoicemyte.com</a>.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 mt-8">
          For any questions about these Terms, contact us at <a href="mailto:support@invoicemyte.com" className="text-blue-600 underline">support@invoicemyte.com</a>.
        </p>
      </section>
    </div>
  );
