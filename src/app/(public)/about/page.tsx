  ...
  return (
    <div className="relative z-10 py-20 px-4 w-full">
      ...
      <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
        InvoiceMyte is brought to you by a dynamic team of developers, designers and support staff who are also freelancers. We built the tool we always wished we had — crafted with passion and insight from real-world experience.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="text-center max-w-xs">
          ...
          <h4 className="font-bold text-lg">Stacy Van De Berg</h4>
        ...
        <div className="text-center max-w-xs">
          ...
          <h4 className="font-bold text-lg">Peter Jones</h4>
          <p className="text-muted-foreground">Head of Support</p>
        </div>
        ...
        <div className="text-center max-w-xs">
          ...
          <h4 className="font-bold text-lg">Mary Williams</h4>
          <p className="text-muted-foreground">Support Specialist</p>
        </div>
  </div>
