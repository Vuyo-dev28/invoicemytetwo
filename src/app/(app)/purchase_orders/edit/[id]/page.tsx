  ...
  if (document.status !== 'draft') {
    return (
        <div className="text-center p-8">
            <h1 className="text-2xl font-bold">Cannot Edit Purchase Order</h1>
            <p className="text-muted-foreground">This purchase order is not a draft and cannot be edited.</p>
        </div>
    )
  }
